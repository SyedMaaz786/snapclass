...
def teacher_dashboard():
    ...
    c1, c2 = st.columns([3, 2], vertical_alignment='center', gap='xxlarge')
    with c1:
        header_dashboard()
    with c2:
        st.markdown(f"""
...
<h2>Welcome, {teacher_data['name']}</h2>
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder='e.g. John Doe')
